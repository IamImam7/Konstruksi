...
<header>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav nav-tabs navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="content/list-lightcone.php">Lightcone</a>
              </li>
    ...
    while ($row = mysqli_fetch_assoc($result))
              ...
              <div class="light-cones">
                <div class="light-cones-item">
                  <img class="light-cones-image rarity-4" src="../form/dashboard/admin/LightCones/<?php echo $row['gambar']; ?>" />
