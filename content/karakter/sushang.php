<?php
  ...
  // Query karakter
  $query_karakter = "SELECT * FROM karakter_hsr WHERE nama = 'Sushang'";
  ...
  ('In the Night', 'Sleep Like the Dead' , 'Cruising in the Stellar Sea' ,'Swordplay', 'Only Silence Remains','Worrisome, Blissful','River Flows in Spring','Baptism of Pure Thought','Subscribe for More!','Return to Darkness')";
  ...
  ('Firmament Frontline: Glamoth','Rutilant Arena')";
    ...
    <main class="content" >
        ...
        <div class="character-info-skills" id="skills">
          <h2 class="character-info-category">Skills</h2>
            ...
            <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1206_Normal.png" alt="Cloudfencer Art: Starshine" />
            <h3 class="character-info-skill-title">Basic ATK</h3>
            </div>
          <div class="character-info-skill-body">
            <h4 class="character-info-skill-name">Cloudfencer Art: Starshine</h4>
            <h5 class="character-info-skill-type">Single Target</h5>
            <p class="character-info-skill-description">Memberikan Physical DMG sebesar 50% dari ATK Sushang kepada satu musuh.</p>
          </div>
        </div>

        <div class="character-info-skill">
          <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1206_BP.png" alt="Cloudfencer Art: Mountainfall" />
                <h3 class="character-info-skill-title">Skill</h3>
          </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Cloudfencer Art: Mountainfall</h4>
                  <h5 class="character-info-skill-type">Single Target</h5>
                    <p class="character-info-skill-description">
                    Mengakibatkan Physical DMG sebesar 1.05% ATK Sushang pada 1 target musuh. Setelah serangan terakhir, memiliki 0.33% peluang untuk melancarkan "Sword Stance", mengakibatkan Physical DMG tambahan sebesar 0.5% ATK Sushang pada target. Jika target tersebut dalam status Weakness Break, maka dijamin akan melancarkan "Sword Stance".
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1206_Passive.png" alt="Dancing Blade" />
                <h3 class="character-info-skill-title">Talent</h3>
                </div>
                <div class="character-info-skill-body">
                  <h4 class="character-info-skill-name">Dancing Blade</h4>
                  <h5 class="character-info-skill-type">Support</h5>
                <p class="character-info-skill-description">
                Saat ada target musuh dengan Weakness Break di medan pertempuran, SPD Sushang akan meningkat 15% selama 2 giliran.
                </p>
            </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1206_Maze.png" alt="Cloudfencer Art: Warcry" />
                  <h3 class="character-info-skill-title">Technique</h3>
                </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Cloudfencer Art: Warcry</h4>
                <h5 class="character-info-skill-type"></h5>
                <p class="character-info-skill-description">
                Secara langsung menyerang musuh. Setelah Memasuki pertarungan, Sushang memberikan Physical DMG yang setara dengan 80% ATK nya ke seluruh musuh</p>
              </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
                <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1206_Ultra_on.png" alt="Shape of Taixu: Dawn Herald" />
                    <h3 class="character-info-skill-title">Ultimate</h3>
                    </div>
                  <div class="character-info-skill-body">
                    <h4 class="character-info-skill-name">Shape of Taixu: Dawn Herald</h4>
                    <h5 class="character-info-skill-type">Single Target</h5>
                      <p class="character-info-skill-description">Mengakibatkan Physical DMG sebesar 1.92% ATK Sushang pada 1 target musuh dan membuat Sushang segera beraksi lagi. Selain itu, ATK Sushang meningkat 0.18%. Saat melancarkan Skill, akan ada 2 kesempatan tambahan untuk memicu "Sword Stance", berlangsung selama 2 giliran. "Sword Stance" yang dilancarkan dari kesempatan tambahan akan mengakibatkan DMG sebesar 0.5% dari DMG awal.</p>
              </div>
          </div>
          </div>
          ...
          <div class="character-info-skills" id="eidolons">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1206_Rank1.png" alt="Cut With Ease" />
                      <h3 class="character-info-skill-title">Eidolon 1</h3>
                    </div>
                    <div class="character-info-skill-body">Cut With Ease</h4>
                      <p class="character-info-skill-description">Memulihkan 1 Poin Skill setelah melancarkan Skill pada musuh dengan status Weakness Break.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1206_Rank2.png" alt="Refine in Toil" />
                      <h3 class="character-info-skill-title">Eidolon 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Refine in Toil</h4>
                      <p class="character-info-skill-description">Setelah memicu "Sword Stance", DMG yang diterima Sushang berkurang 20% selama 1 giliran.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1206_Ultra.png" alt="Rise From Fame"/>
                      <h3 class="character-info-skill-title">Eidolon 3</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Rise From Fame</h4>
                      <p class="character-info-skill-description">Level Ultimate +2, maksimal Lv. 15. Level Talent +2, maksimal Lv. 15.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1206_Rank4.png" alt="Cleave With Heart"  />
                      <h3 class="character-info-skill-title">Eidolon 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Cleave With Heart</h4>
                      <p class="character-info-skill-description">Meningkatkan 40% Break Effect milik Sushang.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1206_BP.png" alt="Prevail via Taixu" />
                      <h3 class="character-info-skill-title">Eidolon 5</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Prevail via Taixu</h4>
                      <p class="character-info-skill-description">Level Skill +2, maksimal Lv. 15. Level Basic Attack +1, maksimal Lv. 10.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1206_Rank6.png" alt="Dwell Like Water"  />
                      <h3 class="character-info-skill-title">Eidolon 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Dwell Like Waters</h4>
                      <p class="character-info-skill-description">Efek peningkatan SPD dari Talent dapat ditumpuk hingga 2 lapis. Selain itu, Sushang akan segera mendapatkan 1 lapis efek peningkatan SPD dari Talent saat memasuki pertempuran.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="character-info-skills" id="traces">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/Nightshade.png" alt="Guileless" />
                      <h3 class="character-info-skill-title">Ascension 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Guileless</h4>
                      <p class="character-info-skill-description">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/Riposte.png" alt="Riposte" />
                      <h3 class="character-info-skill-title">Ascension 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Riposte</h4>
                      <p class="character-info-skill-description">Untuk setiap "Sword Stance" yang dilancarkan, DMG yang diakibatkan "Sword Stance" akan meningkat 2%, efek tersebut dapat ditumpuk hingga 10 lapis.</p>
                    </div>
                  </div>

                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/Vanquisher.png" alt="Vanquisher" />
                      <h3 class="character-info-skill-title">Ascension 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Vanquisher</h4>
                      <p class="character-info-skill-description">Setelah melancarkan Basic Attack atau Skill, jika ada target musuh yang terkena Weakness Break di medan pertempuran, aksi Sushang didahulukan 15%.</p>
                    </div>
                  </div>
                </div>
            ...
            <h3 class="character-info-skill-title">Basic ATK</h3>
               ...
               <div class="character-info-kelebihan" style="background-color: #1a237e;">
                  <div class="row">
                  <iframe width="700" height="600" src="https://www.youtube.com/embed/xNS9fDi67n8?si=wb-bmX5R6q1slNEQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                  </div>
               </div>
               </div>
