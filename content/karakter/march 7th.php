<?php
  ...
  // Query karakter
  $query_karakter = "SELECT * FROM karakter_hsr WHERE nama = 'March 7th'";
  ...
  ('Moment of Victory', 'Day One of My New Life' , 'This Is Me!' ,'We Are Wildfire', 'Amber')";
  ...
  ('Knight of Purity Palace','Hunter of Glacial Forest')";
  ...
  ('Belobog of the Architects','Sprightly Vonwacq')";
    ...
    <main class="content" >
        ...
        <div class="character-info-build">
                    <div class="character-info-build-section">
                      ...
                      <div class="character-info-stats">
                        <div class="character-info-stats-item"><b>Body:</b>DEF% / Effect Hit Rate</div>
        ...
        <div class="character-info-skills" id="skills">
          <h2 class="character-info-category">Skills</h2>
            ...
            <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1001_Normal.png" alt="Frigid Cold Arrow" />
            <h3 class="character-info-skill-title">Basic Attack</h3>
            </div>
          <div class="character-info-skill-body">
            <h4 class="character-info-skill-name">Frigid Cold Arrow</h4>
            <h5 class="character-info-skill-type">Single Target</h5>
            <p class="character-info-skill-description">Memberikan Ice DMG sebesar 50% dari ATK March 7th kepada satu musuh.</p>
          </div>
        </div>

        <div class="character-info-skill">
          <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1001_BP.png" alt="The Power of Cuteness" />
                <h3 class="character-info-skill-title">Skill</h3>
          </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">The Power of Cuteness</h4>
                  <h5 class="character-info-skill-type">Defense</h5>
                    <p class="character-info-skill-description">
                    Memberikan Shield yang dapat menahan DMG sebesar 0.38% DEF March 7th + 190 pada 1 rekan tim selama 3 giliran. Jika persentase HP rekan tersebut lebih dari atau sama dengan 0.3%, maka peluangnya diserang musuh akan meningkat pesat.
                    </p>
                  </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1001_Passive.png" alt="Girl Power" />
                <h3 class="character-info-skill-title">Talent</h3>
                </div>
                <div class="character-info-skill-body">
                  <h4 class="character-info-skill-name">Girl Power</h4>
                  <h5 class="character-info-skill-type">Single Target</h5>
                <p class="character-info-skill-description">
                Setelah rekan tim yang ber-Shield terkena serangan musuh, March 7th segera melancarkan Serangan Balasan yang mengakibatkan Ice DMG sebesar 0.5% ATK March 7th pada penyerang. Efek ini dapat terpicu 2 kali di setiap giliran.
                </p>
            </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1001_Maze.png" alt="Freezing Beauty" />
                  <h3 class="character-info-skill-title">Technique</h3>
                </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Freezing Beauty</h4>
                <h5 class="character-info-skill-type"></h5>
                <p class="character-info-skill-description">
                Secara langsung menyerang musuh. Setelah memasuki pertarungan, ada kemungkinan 100% kemungkinan dasar untuk memberi efek Freeze kepada musuh secara acak selama 1 Turn. Ketika terkena efek Freeze, musuh tidak dapat bergerak dan akan menerima Ice DMG yang setara dengan 50% ATK march 7th saat awal dari setiap turn 
</p>
              </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
                <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1001_Ultra_on.png" alt="Glacial Cascade" />
                    <h3 class="character-info-skill-title">Ultimate</h3>
                    </div>
                  <div class="character-info-skill-body">
                    <h4 class="character-info-skill-name">Glacial Cascade</h4>
                    <h5 class="character-info-skill-type">AoE ATK</h5>
                      <p class="character-info-skill-description">Mengakibatkan Ice DMG sebesar 0.9% ATK March 7th kepada seluruh musuh. Target musuh yang terkena serangan memiliki 0.5% peluang dasar untuk memasuki status Frozen selama 1 giliran. Saat dalam status Frozen, target musuh tidak dapat beraksi dan di saat bersamaan akan menerima Ice DMG tambahan sebesar 0.3% ATK March 7th setiap kali gilirannya dimulai.</p>
              </div>
          </div>
          </div>
          ...
          <div class="character-info-skills" id="eidolons">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1001_Rank1.png" alt="Memory of You"/>
                      <h3 class="character-info-skill-title">Eidolon 1</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Memory of You</h4>
                      <p class="character-info-skill-description">Memulihkan 6 Energy March 7th setiap kali Ultimate membekukan 1 target.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1001_Rank2.png" alt="Memory of It"  />
                      <h3 class="character-info-skill-title">Eidolon 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Memory of It</h4>
                      <p class="character-info-skill-description">Saat memasuki pertempuran, memberikan Shield sebesar 24% DEF March 7th +320 pada rekan tim dengan persentase HP terendah selama 3 giliran.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1001_Ultra.png" alt="Memory of Everything"/>
                      <h3 class="character-info-skill-title">Eidolon 3</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Memory of Everything"</h4>
                      <p class="character-info-skill-description">Level Ultimate +2, maksimal Lv. 15. Level Basic Attack +1, maksimal Lv. 10.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1001_Rank4.png" alt="Never Forfeit Again" />
                      <h3 class="character-info-skill-title">Eidolon 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Never Forfeit Again</h4>
                      <p class="character-info-skill-description">Jumlah efek Serangan Balasan dari Talent yang dapat dipicu setiap giliran bertambah 1 kali. Meningkatkan DMG dari Serangan Balasan sebesar 30% DEF March 7th.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1001_BP.png" alt="Never Forget Again" />
                      <h3 class="character-info-skill-title">Eidolon 5</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Never Forget Again</h4>
                      <p class="character-info-skill-description">Level Skill +2, maksimal Lv. 15. Level Talent +2, maksimal Lv. 15.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1001_Rank6.png" alt="Just Like This, Always..."  />
                      <h3 class="character-info-skill-title">Eidolon 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Just Like This, Always...</h4>
                      <p class="character-info-skill-description">Rekan tim yang dilindungi Shield dari Skill ini akan memulihkan HP sebesar 4% Max HP masing-masing +106 setiap saat gilirannya dimulai.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="character-info-skills" id="traces">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1001_Rank1.png" alt="Purify" />
                      <h3 class="character-info-skill-title">Ascension 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Purify</h4>
                      <p class="character-info-skill-description">
                      Skill dapat menghilangkan 1 debuff dari rekan tim
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1001_Rank2.png" alt="Reinforce" />
                      <h3 class="character-info-skill-title">Ascension 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Reinforce</h4>
                      <p class="character-info-skill-description">Durasi shield yang dibuat dari skill bertambah untuk 1 turn</p>
                    </div>
                  </div>

                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1001_Ultra.png" alt="Ice Spell" />
                      <h3 class="character-info-skill-title">Ascension 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Ice Spell</h4>
                      <p class="character-info-skill-description">Saat melancarkan Ultimate, meningkatkan 15% peluang dasar untuk menyebabkan status Frozen pada target musuh.</p>
                    </div>
                  </div>
                </div>
            ...
            <h3 class="character-info-skill-title">Basic Attack</h3>
               ...
               <div class="character-info-kelebihan" style="background-color: #1a237e;">
                  <div class="row">
                  <iframe width="700" height="600" src="https://www.youtube.com/embed/JGJtciUYQnM?si=tC5I4uKL_ML9coLb" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                  </div>
               </div>
               </div>
