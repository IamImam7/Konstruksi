<?php
  ...
  // Query karakter
  $query_karakter = "SELECT * FROM karakter_hsr WHERE nama = 'Bailu'";
    ...
    <main class="content" >
        ...
        <div class="character-info-build">
                    <div class="character-info-build-section">
                      ...
                      <div class="character-info-stats">
                        <div class="character-info-stats-item"><b>Body:</b>Body:</b> Outgoing Healing Boost</div>
                        <div class="character-info-stats-item"><b>Feet:</b> HP% / Speed</div>
                        <div class="character-info-stats-item"><b>Planar Sphere:</b> HP%</div>
                        <div class="character-info-stats-item"><b>Link Rope:</b>Energy Regen Rate / HP%</div>
                      </div>
                    </div>
                    <div class="character-info-build-section">
        ...
        <div class="character-info-skills" id="skills">
          <h2 class="character-info-category">Skills</h2>
            ...
            <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1211_Normal.png" alt="Diagnostic Kick" />
            <h3 class="character-info-skill-title">Basic ATK</h3>
            </div>
          <div class="character-info-skill-body">
            <h4 class="character-info-skill-name">Diagnostic Kick</h4>
            <h5 class="character-info-skill-type">Single Target</h5>
            <p class="character-info-skill-description">Memberikan Lightning DMG sebesar 50% dari ATK Bailu kepada satu musuh.</p>
          </div>
        </div>

        <div class="character-info-skill">
          <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1211_BP.png" alt="Singing Among Clouds" />
                <h3 class="character-info-skill-title">Skill</h3>
          </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Singing Among Clouds</h4>
                  <h5 class="character-info-skill-type">Restore</h5>
                    <p class="character-info-skill-description">
                    Segera memulihkan HP 1 rekan sebesar 8% Max HP Bailu + 78. Lalu, Bailu akan memberikan 2 kali pemulihan pada rekan tim secara acak. Jumlah HP yang dipulihkan akan berkurang 0.15% dari setiap pemulihan ke pemulihan berikutnya.
                    </p>
                  </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1211_Passive.png" alt="Gourdful Elixir" />
                <h3 class="character-info-skill-title">Talent</h3>
                </div>
                <div class="character-info-skill-body">
                  <h4 class="character-info-skill-name">Gourdful Elixir</h4>
                  <h5 class="character-info-skill-type">Restore</h5>
                <p class="character-info-skill-description">
                Setelah rekan tim yang memiliki "Invigoration" terkena serangan, HP mereka akan pulih sebesar 4% Max HP Bailu +36, efek ini dapat terpicu 2 kali. Saat rekan tim Bailu terkena serangan mematikan, rekan tersebut tidak akan gugur. Bailu akan segera memberikan pemulihan HP kepadanya sebesar 0.12% Max HP Bailu +120. Efek ini dapat dipicu sekali dalam 1 pertempuran.
                </p>
            </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1211_Maze.png" alt="Saunter in the Rain"/>
                  <h3 class="character-info-skill-title">Technique</h3>
                </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Saunter in the Rain</h4>
                <h5 class="character-info-skill-type">Enhance</h5>
                <p class="character-info-skill-description">
                Setelah menggunakan Technique, memberikan "Invigoration" pada seluruh rekan tim saat pertempuran berikutnya dimulai. Efek berlangsung selama 2 giliran.</p>
              </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
                <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1211_Ultra_on.png" alt="Felicitous Thunderleap" />
                    <h3 class="character-info-skill-title">Ultimate</h3>
                    </div>
                  <div class="character-info-skill-body">
                    <h4 class="character-info-skill-name">Felicitous Thunderleap</h4>
                    <h5 class="character-info-skill-type">Restore</h5>
                      <p class="character-info-skill-description">Segera memulihkan HP seluruh rekan tim sebesar 9% Max HP Bailu +90. Bailu akan memberikan efek "Invigoration" pada rekan tim yang belum memiliki "Invigoration". Bailu akan menambah durasi "Invigoration" selama 1 giliran untuk rekan tim yang sudah memiliki "Invigoration". "Invigoration" dapat berlangsung selama 2 giliran dan tidak dapat ditumpuk.</p>
              </div>
          </div>
          </div>
          ...
          <div class="character-info-skills" id="eidolons">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1211_Rank1.png" alt="Ambrosial Aqua" />
                      <h3 class="character-info-skill-title">Eidolon 1</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Ambrosial Aqua</h4>
                      <p class="character-info-skill-description">Saat efek "Invigoration" berakhir, jika HP rekan saat ini sudah pulih sepenuhnya, maka akan memulihkan 8 Energy tambahan untuknya.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1211_Rank2.png" alt="Sylphic Slumber"/>
                      <h3 class="character-info-skill-title">Eidolon 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Sylphic Slumber</h4>
                      <p class="character-info-skill-description">Setelah melancarkan Ultimate, meningkatkan 15% Outgoing Healing selama 2 giliran.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1211_BP.png" alt="Omniscient Opulence"/>
                      <h3 class="character-info-skill-title">Eidolon 3</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Omniscient Opulence</h4>
                      <p class="character-info-skill-description">Level Skill +2, maksimal Lv. 15. Level Talent +2, maksimal Lv. 15.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1211_Rank4.png" alt="Evil Excision"  />
                      <h3 class="character-info-skill-title">Eidolon 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Evil Excision</h4>
                      <p class="character-info-skill-description">Setiap pemulihan dari Skill akan meningkatkan 10% DMG penerima pemulihan. Dapat ditumpuk 3 lapis selama 2 giliran.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1211_Ultra.png" alt="Waning Worries" />
                      <h3 class="character-info-skill-title">Eidolon 5</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Waning Worries</h4>
                      <p class="character-info-skill-description">Level Ultimate +2, maksimal Lv. 15. Level Basic Attack +1, maksimal Lv. 10.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1211_Rank6.png" alt="Drooling Drop of Draconic Divinity"  />
                      <h3 class="character-info-skill-title">Eidolon 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Drooling Drop of Draconic Divinity</h4>
                      <p class="character-info-skill-description">Dalam satu pertempuran, jumlah pemulihan Bailu terhadap rekan tim yang terkena serangan mematikan bertambah 1 kali.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="character-info-skills" id="traces">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1211_Rank1.png" alt="Qihuang Analects" />
                      <h3 class="character-info-skill-title">Ascension 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Qihuang Analects</h4>
                      <p class="character-info-skill-description">
                      Saat Bailu mengakibatkan pemulihan berlebihan pada rekan tim, akan meningkatkan 10% Max HP target tersebut selama 2 giliran.
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1211_Rank2.png" alt="Vidyadhara Geo-Veins" />
                      <h3 class="character-info-skill-title">Ascension 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Vidyadhara Geo-Veins</h4>
                      <p class="character-info-skill-description">Pemicuan efek "Invigoration" bertambah 1 kali.</p>
                    </div>
                  </div>

                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1211_Ultra.png" alt="Aquatic Benediction" />
                      <h3 class="character-info-skill-title">Ascension 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Aquatic Benedictio</h4>
                      <p class="character-info-skill-description">Mengurangi 10% DMG yang diterima karakter berefek "Invigoration".</p>
                    </div>
                  </div>
                </div>
            ...
            <h3 class="character-info-skill-title">Basic ATK</h3>
               ...
               <div class="character-info-kelebihan" style="background-color: #1a237e;">
                  <div class="row">
                  <iframe width="700" height="500" src="https://www.youtube.com/embed/HOod4wRH804?si=pbp-VpbtaQpDtcaL" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                  </div>
               </div>
               </div>
