<?php
  ...
  // Query karakter
  $query_karakter = "SELECT * FROM karakter_hsr WHERE nama = 'Gepard'";
  ...
  ('Moment of Victory', 'Texture of Memories' , 'Landau Choice' ,'Day One of My New Life', 'Amber')";
    ...
    <main class="content" >
        ...
        <div class="character-info-build">
                    <div class="character-info-build-section">
                      ...
                      <div class="character-info-stats">
                        ...
                        <div class="character-info-stats-item"><b>Feet:</b>DEF% </div>
                        <div class="character-info-stats-item"><b>Planar Sphere:</b> DEF% / Ice DMG</div>
        ...
        <div class="character-info-skills" id="skills">
          <h2 class="character-info-category">Skills</h2>
            ...
            <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1104_Normal.png" alt="Fist of Conviction" />
            <h3 class="character-info-skill-title">Basic Attack</h3>
            </div>
          <div class="character-info-skill-body">
            <h4 class="character-info-skill-name">Fist of Conviction</h4>
            <h5 class="character-info-skill-type">Single Target</h5>
            <p class="character-info-skill-description">Memberikan Ice DMG sebesar 50% dari ATK Gepard kepada satu musuh.</p>
          </div>
        </div>

        <div class="character-info-skill">
          <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1104_BP.png" alt="Daunting Smite" />
                <h3 class="character-info-skill-title">Skill</h3>
          </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Daunting Smite</h4>
                  <h5 class="character-info-skill-type">Impair</h5>
                    <p class="character-info-skill-description">
                    Mengakibatkan Ice DMG sebesar 1% ATK Gepard pada 1 target musuh. Di saat bersamaan, target musuh yang terkena serangan memiliki 0.65% peluang dasar untuk memasuki status Frozen selama 1 giliran. Selama dalam status Frozen, target musuh tidak dapat beraksi dan di saat bersamaan akan menerima Ice DMG tambahan sebesar 0.3% ATK Gepard setiap gilirannya dimulai.
                    </p>
                  </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1104_Passive.png" alt="Unyielding Will" />
                <h3 class="character-info-skill-title">Talent</h3>
                </div>
                <div class="character-info-skill-body">
                  <h4 class="character-info-skill-name">Unyielding Will</h4>
                  <h5 class="character-info-skill-type">Restore</h5>
                <p class="character-info-skill-description">
                Saat menerima serangan mematikan, Gepard tidak akan gugur dan segera memulihkan HP-nya sebesar 0.25% dari Max HP-nya. Efek ini hanya dapat terpicu sekali dalam 1 pertempuran.
                </p>
            </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1104_Maze.png" alt="Comradery" />
                  <h3 class="character-info-skill-title">Technique</h3>
                </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Comradery</h4>
                <h5 class="character-info-skill-type">Defense</h5>
                <p class="character-info-skill-description">
                Setelah menggunakan Technique, saat pertempuran selanjutnya dimulai, akan memberikan Shield yang dapat menahan DMG sebesar 0.24% DEF Gepard + 150 kepada seluruh rekan selama 2 giliran.
</p>
              </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
                <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1104_Ultra_on.png" alt="Enduring Bulwark" />
                    <h3 class="character-info-skill-title">Ultimate</h3>
                    </div>
                  <div class="character-info-skill-body">
                    <h4 class="character-info-skill-name">Enduring Bulwark</h4>
                    <h5 class="character-info-skill-type">Defense</h5>
                      <p class="character-info-skill-description">Memberikan Shield yang dapat menahan DMG sebesar 0.3% DEF Gepard +150 pada seluruh rekan tim selama 3 giliran.</p>
              </div>
          </div>
          </div>
          ...
          <div class="character-info-skills" id="eidolons">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1104_Rank1.png" alt="Due Diligence"/>
                      <h3 class="character-info-skill-title">Eidolon 1</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Due Diligence</h4>
                      <p class="character-info-skill-description">Saat melancarkan skill, meningkatkan 35% peluang dasar untuk membuat target musuh memasuki status Frozen.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1104_Rank2.png" alt="Lingering Cold"  />
                      <h3 class="character-info-skill-title">Eidolon 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Lingering Cold</h4>
                      <p class="character-info-skill-description">Setelah status Frozen yang disebabkan oleh Skill Gepard pada target musuh terhapus, SPD target akan berkurang 20% selama 1 giliran.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1104_Ultra.png" alt="Never Surrender"/>
                      <h3 class="character-info-skill-title">Eidolon 3</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Never Surrender</h4>
                      <p class="character-info-skill-description">Level Ultimate +2, maksimal Lv. 15. Level Talent +2, maksimal Lv. 15.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1104_Rank4.png" alt="Faith Moves Mountains" />
                      <h3 class="character-info-skill-title">Eidolon 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Faith Moves Mountains</h4>
                      <p class="character-info-skill-description">Saat Gepard berada di medan pertempuran, Effect RES seluruh rekan tim meningkat 20%..</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1104_BP.png" alt="Cold Iron Fist" />
                      <h3 class="character-info-skill-title">Eidolon 5</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Cold Iron Fist</h4>
                      <p class="character-info-skill-description">Level Skill +2, maksimal Lv. 15. Level Basic Attack +1, maksimal Lv. 10.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1104_Rank6.png" alt="Unyielding Resolve"  />
                      <h3 class="character-info-skill-title">Eidolon 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Unyielding Resolve</h4>
                      <p class="character-info-skill-description">Saat Talent Gepard terpicu, Gepard akan segera beraksi lagi dan memberikan pemulihan HP tambahan sebesar 50% Max HP-nya.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="character-info-skills" id="traces">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1104_Rank1.png" alt="Integrity" />
                      <h3 class="character-info-skill-title">Ascension 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Integrity</h4>
                      <p class="character-info-skill-description">
                      Meningkatkan Kemungkinan Gepard akan diserang oleh musuh
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1104_Rank2.png" alt="Commander" />
                      <h3 class="character-info-skill-title">Ascension 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Commander</h4>
                      <p class="character-info-skill-description">Ketika pasif "Unyielding Will" terpicu,Energy Gepard akan langsung terisi penuh sebanyak 100%</p>
                    </div>
                  </div>

                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1104_Ultra.png" alt="Fighting Spirit" />
                      <h3 class="character-info-skill-title">Ascension 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Fighting Spirit</h4>
                      <p class="character-info-skill-description">Meningkatkan ATK Gepard sebesar 35% DEF-nya saat ini. Efek ini di-refresh setiap gilirannya dimulai.</p>
                    </div>
                  </div>
                </div>
            ...
            <h3 class="character-info-skill-title">Basic Attack</h3>
               ...
               <div class="character-info-kelebihan" style="background-color: #1a237e;">
                  <div class="row">
                  <iframe width="700" height="500" src="https://www.youtube.com/embed/r_RvvPc5mLA?si=wI_39YmNij4MWPx4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                  </div>
               </div>
               </div>
</div>
