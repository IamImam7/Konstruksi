<?php
  ...
  // Query karakter
  $query_karakter = "SELECT * FROM karakter_hsr WHERE nama = 'qingque'";
  ...
  ('Before Dawn', 'Today is Another Peaceful Day' , 'Night on the Milky Way' ,'Geniuses Repose', 'The Seriousness of Breakfast')";
    ...
    <main class="content" >
        ...
        <div class="character-info-skills" id="skills">
          <h2 class="character-info-category">Skills</h2>
            ...
            <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1201_Normal.png" alt="Flower Pick" />
            <h3 class="character-info-skill-title">Basic Attack</h3>
            </div>
          <div class="character-info-skill-body">
            <h4 class="character-info-skill-name">Flower Pick</h4>
            <h5 class="character-info-skill-type">Single Target</h5>
            <p class="character-info-skill-description">Melemparkan 1 Jade Tile yang jumlah polanya paling sedikit dan mengakibatkan Quantum DMG sebesar 50% ATK Qingque pada 1 target musuh.</p>
          </div>
        </div>

        <div class="character-info-skill">
          <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1201_BP.png" alt="A Scoop of Moon" />
                <h3 class="character-info-skill-title">Skill</h3>
          </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">A Scoop of Moon</h4>
                  <h5 class="character-info-skill-type">>Enhance</h5>
                    <p class="character-info-skill-description">
                    Segera mengambil 2 lembar Jade Tile dan meningkatkan 0.14% DMG Qingque hingga gilirannya berakhir, efek ini dapat ditumpuk hingga 4 lapis. Giliran saat ini tidak akan berakhir setelah melancarkan Skill ini.
                    </p>
                  </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1201_Passive.png" alt="Celestial Jade" />
                <h3 class="character-info-skill-title">Talent</h3>
                </div>
                <div class="character-info-skill-body">
                  <h4 class="character-info-skill-name">Celestial Jade</h4>
                  <h5 class="character-info-skill-type">Enhance</h5>
                <p class="character-info-skill-description">
                Saat giliran rekan tim dimulai, Qingque akan mengambil secara acak 1 dari 3 Jade Tile dengan pola yang berbeda, Qingque maksimal memiliki 4 Jade Tile. Saat gilirannya dimulai, jika Qingque memiliki 4 Jade Tile berpola sama, Qingque akan mengonsumsi semua Jade Tile dan memasuki status "Hidden Hand". Dalam status "Hidden Hand", Qingque tidak dapat melancarkan Skill lagi, di saat yang bersamaan akan meningkatkan 0.36% ATK dirinya sendiri, lalu Basic ATK "Flower Pick" akan diperkuat menjadi "Cherry on Top!". Status "Hidden Hand" akan hilang setelah melancarkan "Cherry on Top!".
                </p>
            </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1201_Maze.png" alt="Game Solitaire" />
                  <h3 class="character-info-skill-title">Technique</h3>
                </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Game Solitaire</h4>
                <h5 class="character-info-skill-type">Enhance</h5>
                <p class="character-info-skill-description">
                Setelah menggunakan Technique, Qingque akan mengambil 2 lembar Jade Tile saat memasuki pertempuran.
</p>
              </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
                <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1201_Ultra_on.png" alt="A Quartet? Woo-hoo!"/>
                    <h3 class="character-info-skill-title">Ultimate</h3>
                    </div>
                  <div class="character-info-skill-body">
                    <h4 class="character-info-skill-name">A Quartet? Woo-hoo!</h4>
                    <h5 class="character-info-skill-type">AoE ATK</h5>
                      <p class="character-info-skill-description">Mengakibatkan Quantum DMG sebesar 1.2% ATK Qingque pada seluruh musuh, serta mendapatkan 4 Jade Tile dengan pola yang sama.</p>
              </div>
          </div>
          </div>
          ...
          <div class="character-info-skills" id="eidolons">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1201_Rank1.png" alt="Rise Through the Tiles"/>
                      <h3 class="character-info-skill-title">Eidolon 1</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Rise Through the Tiles</h4>
                      <p class="character-info-skill-description">Meningkatkan 10% DMG yang diakibatkan Ultimate.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1201_Rank2.png" alt="Sleep on the Tiles"  />
                      <h3 class="character-info-skill-title">Eidolon 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Sleep on the Tiles</h4>
                      <p class="character-info-skill-description">Segera memulihkan 1 Energy Qingque setiap Qingque memicu pengambilan kartu.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1201_Ultra.png" alt="Read Between the Tiles"/>
                      <h3 class="character-info-skill-title">Eidolon 3</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Read Between the Tiles</h4>
                      <p class="character-info-skill-description">Level Ultimate +2, maksimal Lv. 15. Level Talent +2, maksimal Lv. 15.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1201_Rank4.png" alt="Right on the Tiles" />
                      <h3 class="character-info-skill-title">Eidolon 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Right on the Tiles</h4>
                      <p class="character-info-skill-description">Setelah melancarkan Skill, memiliki 24% peluang tetap untuk memperoleh status "Autarky" hingga akhir giliran saat ini. Setelah melancarkan Basic Attack atau Enhanced Basic Attack dalam status "Autarky", Qingque akan langsung melancarkan 1 Serangan Lanjutan yang mengakibatkan Quantum DMG pada target sebesar 100% dari Basic Attack DMG atau Enhanced Basic Attack DMG.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1201_BP.png" alt="Gambit for the Tiles" />
                      <h3 class="character-info-skill-title">Eidolon 5</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Gambit for the Tiles</h4>
                      <p class="character-info-skill-description">Level Skill +2, maksimal Lv. 15. Level Basic Attack +1, maksimal Lv. 10.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1201_Rank6.png" alt="Prevail Beyond the Tiles"  />
                      <h3 class="character-info-skill-title">Eidolon 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Prevail Beyond the Tiles</h4>
                      <p class="character-info-skill-description">Memulihkan 1 Poin Skill setelah melancarkan Enhanced Basic Attack.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="character-info-skills" id="traces">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/Tile Battle.png" alt="Tile Battle" />
                      <h3 class="character-info-skill-title">Ascension 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Tile Battle</h4>
                      <p class="character-info-skill-description">
                      Memulihkan 1 Poin Skill saat melancarkan Skill. Efek ini hanya dapat dipicu sekali dalam 1 pertempuran.
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/Bide Time.png" alt="Bide Time" />
                      <h3 class="character-info-skill-title">Ascension 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Bide Time</h4>
                      <p class="character-info-skill-description">Efek peningkatan DMG dari Skill Qingque meningkat 10%.</p>
                    </div>
                  </div>

                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/Winning Hand.png" alt="Winning Hand" />
                      <h3 class="character-info-skill-title">Ascension 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Winning Hand</h4>
            ...
            <h3 class="character-info-skill-title">Basic Attack</h3>
               ...
               <div class="character-info-kelebihan" style="background-color: #1a237e;">
                  <div class="row">
                  <iframe width="700" height="600" src="https://www.youtube.com/embed/Ng9LwmXxO-Y?si=8VKHEmElWD8hKLvf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                  </div>
               </div>
               </div>
