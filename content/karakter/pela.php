<?php
  ...
  // Query karakter
  $query_karakter = "SELECT * FROM karakter_hsr WHERE nama = 'pela'";
  ...
  ('Before the Tutorial Mission', 'Incessant Rain' , 'Resolution Shines As Pearls of Sweat' ,'In the Name of the World', 'Good Night and Sleep Well', 'Eyes of the Prey', 'void')";
  ...
  ('Musketeer of Wild Wheat','Hunter of Glacial Forest')";
  ...
  ('Pan-Galactic Commercial Enterprise','Fleet of the Ageless','Space Sealing Station')";
    ...
    <main class="content" >
        ...
        <div class="character-info-skills" id="skills">
          <h2 class="character-info-category">Skills</h2>
            ...
            <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1106_Normal.png" alt="Frost Shot" />
            <h3 class="character-info-skill-title">Basic Attack</h3>
            </div>
          <div class="character-info-skill-body">
            <h4 class="character-info-skill-name">Frost Shot</h4>
            <h5 class="character-info-skill-type">Single Target</h5>
            <p class="character-info-skill-description">Memberikan Ice DMG sebesar 50% dari ATK Pela kepada satu musuh.</p>
          </div>
        </div>

        <div class="character-info-skill">
          <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1106_BP.png" alt="Frostbite" />
                <h3 class="character-info-skill-title">Skill</h3>
          </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Frostbite</h4>
                  <h5 class="character-info-skill-type">Impair</h5>
                    <p class="character-info-skill-description">
                    Menghilangkan 1 Buff dan mengakibatkan Ice DMG sebesar 1.05% ATK Pela pada 1 target musuh.
                    </p>
                  </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1106_Passive.png" alt="Data Collecting" />
                <h3 class="character-info-skill-title">Talent</h3>
                </div>
                <div class="character-info-skill-body">
                  <h4 class="character-info-skill-name">Data Collecting</h4>
                  <h5 class="character-info-skill-type">Support</h5>
                <p class="character-info-skill-description">
                Jika Pela melancarkan serangan pada musuh yang berada dalam status Debuff, Pela akan memulihkan 5 Energy tambahan. Efek ini hanya dapat dipicu sekali per serangan.
                </p>
            </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1106_Maze.png" alt="Preemptive Strike" />
                  <h3 class="character-info-skill-title">Technique</h3>
                </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Preemptive Strike</h4>
                <h5 class="character-info-skill-type"></h5>
                <p class="character-info-skill-description">
               Secara Langsung menyerang musuh. Saat memasuki pertarungan, Pela memberikan Ice damage yang setara dengan 80% ATK nya ke musuh secara acak, dengan kemungkinan dasar sebesar 100% untuk mengurangi DEF seluruh musuh sebesar 20% selama 2 turn
</p>
              </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
                <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1106_Ultra_on.png" alt="Zone Suppression" />
                    <h3 class="character-info-skill-title">Ultimate</h3>
                    </div>
                  <div class="character-info-skill-body">
                    <h4 class="character-info-skill-name">Zone Suppression</h4>
                    <h5 class="character-info-skill-type">Defense</h5>
                      <p class="character-info-skill-description">Memiliki 1% peluang dasar membuat setiap target musuh memasuki status "Exposed", di saat yang bersamaan juga mengakibatkan Ice DMG sebesar 0.6% ATK Pela pada seluruh musuh. Target musuh yang berstatus "Exposed" akan mengalami 0.3% pengurangan DEF selama 2 giliran.</p>
              </div>
          </div>
          </div>
          ...
          <div class="character-info-skills" id="eidolons">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1106_Rank1.png" alt="Victory Report"/>
                      <h3 class="character-info-skill-title">Eidolon 1</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Victory Report</h4>
                      <p class="character-info-skill-description">Saat ada target musuh yang dikalahkan, Pela akan memulihkan 5 Energy.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1106_Rank2.png" alt="Adamant Charge"  />
                      <h3 class="character-info-skill-title">Eidolon 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Adamant Charge</h4>
                      <p class="character-info-skill-description">Setelah melancarkan Skill untuk menghapus efek Buff, SPD meningkat 10% selama 2 giliran.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1106_BP.png" alt="Suppresive Force"/>
                      <h3 class="character-info-skill-title">Eidolon 3</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Suppresive Force</h4>
                      <p class="character-info-skill-description">Level Skill +2, maksimal Lv. 15. Level Basic Attack +1, maksimal Lv. 10.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1106_Rank4.png" alt="Full Analysis" />
                      <h3 class="character-info-skill-title">Eidolon 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Full Analysis</h4>
                      <p class="character-info-skill-description">Saat melancarkan Skill, memiliki 100% peluang dasar untuk mengurangi 12% Ice RES target musuh selama 2 giliran.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1106_Ultra.png" alt="Absolute Jeopardy" />
                      <h3 class="character-info-skill-title">Eidolon 5</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Absolute Jeopardy</h4>
                      <p class="character-info-skill-description">Level Ultimate +2, maksimal Lv. 15. Level Talent +2, maksimal Lv. 15.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1106_Rank6.png" alt="Feeble Pursuit"   />
                      <h3 class="character-info-skill-title">Eidolon 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Feeble Pursuit</h4>
                      <p class="character-info-skill-description">Jika Pela melancarkan serangan pada target musuh yang terkena efek Debuff, Pela akan mengakibatkan Ice DMG tambahan sebesar 40% ATK Pela.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="character-info-skills" id="traces">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1106_Rank1.png" alt="Bash" />
                      <h3 class="character-info-skill-title">Ascension 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Bash</h4>
                      <p class="character-info-skill-description">
                      Meningkatkan 20% DMG yang diakibatkan pada target musuh yang terkena efek Debuff.
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1106_Rank2.png" alt="The Secret Strategy" />
                      <h3 class="character-info-skill-title">Ascension 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">The Secret Strategy</h4>
                      <p class="character-info-skill-description">Meningkatkan 10% Effect Hit Rate seluruh rekan tim saat Pela berada di medan pertempuran.</p>
                    </div>
                  </div>

                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1106_BP.png" alt="Wipe Out" />
                      <h3 class="character-info-skill-title">Ascension 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Wipe Out</h4>
                      <p class="character-info-skill-description">Saat melancarkan Skill untuk menghilangkan Buff, DMG serangan Pela selanjutnya akan meningkat 20%.</p>
                    </div>
                  </div>
                </div>
            ...
            <h3 class="character-info-skill-title">Basic Attack</h3>
               ...
               <div class="character-info-kelebihan" style="background-color: #1a237e;">
                  <div class="row">
                  <iframe width="700" height="600" src="https://www.youtube.com/embed/9DaAGoQ2nz8?si=2qV3hkqBJMS8aPjI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                  </div>
               </div>
               </div>
