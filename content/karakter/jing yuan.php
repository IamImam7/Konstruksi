<?php
  ...
  // Query karakter
  $query_karakter = "SELECT * FROM karakter_hsr WHERE nama = 'Jing Yuan'";
  ...
  ('Band Of Sizzling Thunder ','The Ashblazing Grand Duke')";
    ...
    <main class="content" >
        ...
        <div class="character-info-skills" id="skills">
          <h2 class="character-info-category">Skills</h2>
            ...
            <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1204_Normal.png" alt="Glistening Light" />
            <h3 class="character-info-skill-title">Basic Attack</h3>
            </div>
          <div class="character-info-skill-body">
            <h4 class="character-info-skill-name">Glistening Light</h4>
            <h5 class="character-info-skill-type">Single Target</h5>
            <p class="character-info-skill-description">Memberikan Lightning DMG sebesar 50% dari ATK Jing Yuan kepada satu musuh.</p>
          </div>
        </div>

        <div class="character-info-skill">
          <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1204_BP.png" alt="Rifting Zenith" />
                <h3 class="character-info-skill-title">Skill</h3>
          </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Rifting Zenith</h4>
                  <h5 class="character-info-skill-type">AoE ATK</h5>
                    <p class="character-info-skill-description">
                    Mengakibatkan Lightning DMG sebesar 0.5% ATK Jing Yuan pada seluruh musuh dan meningkatkan Hits Per Action milik Lightning-Lord sebanyak 2 kali pada giliran berikutnya.
                    </p>
                  </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1204_Passive.png" alt="Prana Extirpated" />
                <h3 class="character-info-skill-title">Talent</h3>
                </div>
                <div class="character-info-skill-body">
                  <h4 class="character-info-skill-name">Prana Extirpated</h4>
                  <h5 class="character-info-skill-type">AoE ATK</h5>
                <p class="character-info-skill-description">
                Memanggil Lightning-Lord saat pertempuran dimulai. Lightning-Lord memiliki 60 SPD dasar dan 3 Hits Per Action, setiap serangannya dihitung sebagai Serangan Lanjutan. Setiap serangan Lightning-Lord akan mengakibatkan Lightning DMG sebesar 0.33% ATK Jing Yuan pada 1 musuh secara acak, serta mengakibatkan Lightning DMG pada target di sekitarnya sebesar 0.25% dari Lightning DMG yang diakibatkan pada target utama. Maksimal Hits Per Action milik Lightning-Lord adalah 10, dan setiap kali Hits Per Action milik Lightning-Lord bertambah 1, SPD-nya akan meningkat 10. Setelah aksinya berakhir, Hits Per Action dan SPD-nya akan kembali seperti semula. Saat Jing Yuan gugur, Lightning-Lord akan menghilang. Saat Jing Yuan terkena Crowd Control Debuff, Lightning-Lord juga tidak dapat beraksi.
                </p>
            </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1204_Maze.png" alt="Spirit Invocation" />
                  <h3 class="character-info-skill-title">Technique</h3>
                </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Spirit Invocation</h4>
                <h5 class="character-info-skill-type">Enhance</h5>
                <p class="character-info-skill-description">
                Setelah menggunakan Technique, menambah Hits Per Action di giliran pertama Lightning-Lord sebanyak 3 saat pertempuran selanjutnya dimulai.
</p>
              </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
                <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1204_Ultra_on.png" alt="Lightbringer"/>
                    <h3 class="character-info-skill-title">Ultimate</h3>
                    </div>
                  <div class="character-info-skill-body">
                    <h4 class="character-info-skill-name">Lightbringer</h4>
                    <h5 class="character-info-skill-type">AoE ATK</h5>
                      <p class="character-info-skill-description">Mengakibatkan Lightning DMG sebesar 1.2% ATK Jing Yuan pada seluruh musuh dan meningkatkan Hits Per Action milik Lightning-Lord sebanyak 3 kali pada giliran berikutnya.</p>
              </div>
          </div>
          </div>
          ...
          <div class="character-info-skills" id="eidolons">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1204_Rank1.png" alt="Slash, Seas Split"/>
                      <h3 class="character-info-skill-title">Eidolon 1</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Slash, Seas Split</h4>
                      <p class="character-info-skill-description">Saat "Lightning-Lord" melancarkan serangan, DMG Multiplier pada musuh di sekitar target utama akan meningkat sebesar 25% DMG Multiplier pada target utama.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1204_Rank2.png" alt="Swing, Skies Squashed"  />
                      <h3 class="character-info-skill-title">Eidolon 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Swing, Skies Squashed</h4>
                      <p class="character-info-skill-description">Setelah "Lightning-Lord" beraksi, meningkatkan 20% DMG yang diakibatkan Basic Attack, Skill, dan Ultimate Jing Yuan selama 2 giliran.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1204_Ultra.png" alt="Strike, Suns Subdued"/>
                      <h3 class="character-info-skill-title">Eidolon 3</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Strike, Suns Subdued</h4>
                      <p class="character-info-skill-description">Level Skill +2, maksimal Lv. 15. Level Basic Attack +1, maksimal Lv. 10.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1204_Rank4.png" alt="Spin, Stars Sieged" />
                      <h3 class="character-info-skill-title">Eidolon 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Spin, Stars Sieged</h4>
                      <p class="character-info-skill-description">Setiap Hit yang dilancarkan Lightning-Lord akan memulihkan 2 Energy Jing Yuan.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1204_BP.png" alt="Stride, Spoils Seized" />
                      <h3 class="character-info-skill-title">Eidolon 5</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Stride, Spoils Seized</h4>
                      <p class="character-info-skill-description">Level Ultimate +2, maksimal Lv. 15. Level Talent +2, maksimal Lv. 15.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1204_Rank6.png" alt="Sweep, Souls Slain"  />
                      <h3 class="character-info-skill-title">Eidolon 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Sweep, Souls Slain</h4>
                      <p class="character-info-skill-description">Setiap Hit yang dilancarkan Lightning-Lord akan mengakibatkan target musuh terkena status Vulnerability. Saat terkena status Vulnerability, target musuh akan menerima 12% DMG lebih banyak hingga akhir giliran Lightning-Lord saat ini, efek ini dapat ditumpuk hingga 3 lapis.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="character-info-skills" id="traces">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1204_Rank1.png" alt="Battalia Crush" />
                      <h3 class="character-info-skill-title">Ascension 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Battalia Crush</h4>
                      <p class="character-info-skill-description">
                      Jika Hits Per Action milik Lightning-Lord pada giliran berikutnya lebih dari atau sama dengan 6, maka CRIT DMG-nya pada giliran berikutnya akan meningkat 25%.
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1204_Rank2.png" alt="Savant Providence" />
                      <h3 class="character-info-skill-title">Ascension 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Savant Providence</h4>
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1204_BP.png" alt="War Marshal" />
                      <h3 class="character-info-skill-title">Ascension 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">War Marshal</h4>
                      <p class="character-info-skill-description">Setelah melancarkan Skill, CRIT Rate meningkat sebesar 10% selama 2 giliran.</p>
                    </div>
                  </div>
                </div>
            ...
            <h3 class="character-info-skill-title">Basic Attack</h3>
               ...
               <div class="character-info-kelebihan" style="background-color: #1a237e;">
                  <div class="row">
                  <iframe width="700" height="500" src="https://www.youtube.com/embed/DGn90VLlndc?si=CFarZeUMlbs-rHS5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                  </div>
               </div>
               </div>
</div>
