<?php
  ...
  // Query karakter
  $query_karakter = "SELECT * FROM karakter_hsr WHERE nama = 'Trailblazer - Preservation'";
  ...
  ('Moment of Victory', 'Texture of Memories' , 'Landau Choice' ,'Day One of My New Life', 'This Is Me!','Trend of the Universal Market','She Already Shut Her Eyes')";
  ...
  ('Knight of Purity Palace','Guard of Wuthering Snow')";
  ...
  ('Sprightly Vonwacq','Belobog of the Architects')";
    ...
    <main class="content" >
        ...
        <div class="character-info-build">
                    <div class="character-info-build-section">
                      ...
                      <div class="character-info-stats">
                        <div class="character-info-stats-item"><b>Body:</b>DEF% </div>
                        <div class="character-info-stats-item"><b>Feet:</b>DEF% / Speed</div>
                        <div class="character-info-stats-item"><b>Planar Sphere:</b> DEF% </div>
                        <div class="character-info-stats-item"><b>Link Rope:</b> DEF% / Energy Regen Rate</div>
                      </div>
                    </div>
                    <div class="character-info-build-section">
        ...
        <div class="character-info-skills" id="skills">
          <h2 class="character-info-category">Skills</h2>
            ...
            <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_8003_Normal.png" alt="Ice-Breaking Light"  />
            <h3 class="character-info-skill-title">Basic Attack</h3>
            </div>
          <div class="character-info-skill-body">
            <h4 class="character-info-skill-name">Ice-Breaking Light</h4>
            <h5 class="character-info-skill-type">Single Target</h5>
            <p class="character-info-skill-description">Memberikan Fire DMG sebesar 50% dari ATK Trailblaze kepada satu musuh.</p>
          </div>
        </div>

        <div class="character-info-skill">
          <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_8003_BP.png" alt="Ever-Burning Amber" />
                <h3 class="character-info-skill-title">Skill</h3>
          </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Ever-Burning Amber</h4>
                  <h5 class="character-info-skill-type">Defense</h5>
                    <p class="character-info-skill-description">
                    Setelah melancarkan Skill, mengurangi 0.4% DMG yang diterima Trailblazer dan memperoleh 1 lapis "Magma Will", serta memiliki 1% peluang dasar untuk membuat musuh memasuki status "Taunt" selama 1 giliran.
                    </p>
                  </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_8003_Passive.png" alt="Treasure of the Architects" />
                <h3 class="character-info-skill-title">Talent</h3>
                </div>
                <div class="character-info-skill-body">
                  <h4 class="character-info-skill-name">Treasure of the Architects</h4>
                  <h5 class="character-info-skill-type">Enhance</h5>
                <p class="character-info-skill-description">
                Setiap 1 serangan yang diterima akan menambah 1 lapis "Magma Will", maksimal hingga 8 lapis. Saat jumlah "Magma Will" tidak kurang dari 4 lapis, Basic Attack akan memperoleh peningkatan dan dapat mengakibatkan DMG pada satu target musuh dan target di sekitarnya. Setelah Trailblazer melancarkan Basic Attack, Skill, atau Ultimate, akan memberikan Shield yang dapat menahan DMG sebesar 4% DEF Trailblazer +20 selama 2 giliran pada seluruh rekan tim.
                </p>
            </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_8003_Maze.png" alt="Call of the Guardian" />
                  <h3 class="character-info-skill-title">Technique</h3>
                </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Call of the Guardian</h4>
                <h5 class="character-info-skill-type">Defense</h5>
                <p class="character-info-skill-description">
                Setelah menggunakan Technique, memberikan Shield yang dapat menahan DMG sebesar 0.3% DEF Trailblazer +384 selama 1 giliran saat pertempuran selanjutnya dimulai.
</p>
              </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
                <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_8003_Ultra_on.png" alt="War-Flaming Lance"  />
                    <h3 class="character-info-skill-title">Ultimate</h3>
                    </div>
                  <div class="character-info-skill-body">
                    <h4 class="character-info-skill-name">War-Flaming Lance</h4>
                    <h5 class="character-info-skill-type">AoE ATK</h5>
                      <p class="character-info-skill-description">Mengakibatkan Fire DMG sebesar 0.5% ATK +0.75% DEF Trailblazer pada seluruh musuh. Saat melancarkan Basic Attack selanjutnya, Trailblazer akan otomatis memperoleh peningkatan tanpa mengonsumsi "Magma Will".</p>
              </div>
          </div>
          </div>
          ...
          <div class="character-info-skills" id="eidolons">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_8003_Rank1.png" alt="Earth-Shaking Resonance"/>
                      <h3 class="character-info-skill-title">Eidolon 1</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Earth-Shaking Resonance</h4>
                      <p class="character-info-skill-description">Melancarkan Basic Attack/Enhanced Basic Attack akan mengakibatkan Fire DMG tambahan sebesar 25%/50% DEF Trailblazer.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_8003_Rank2.png" alt="Time-Defying Tenacity"  />
                      <h3 class="character-info-skill-title">Eidolon 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Time-Defying Tenacity</h4>
                      <p class="character-info-skill-description">Ketika Talent terpicu, kekuatan Shield yang diperoleh untuk seluruh rekan tim akan meningkat sebesar 2% DEF Trailblazer + 27.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_8003_BP.png" alt="Trail-Blazing Blueprint"/>
                      <h3 class="character-info-skill-title">Eidolon 3</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Trail-Blazing Blueprint</h4>
                      <p class="character-info-skill-description">Level Skill +2, maksimal Lv. 15. Level Talent +2, maksimal Lv. 15.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_8003_Rank4.png" alt="Nation-Building Oath" />
                      <h3 class="character-info-skill-title">Eidolon 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Nation-Building Oath</h4>
                      <p class="character-info-skill-description">Segera memperoleh 4 lapis "Magma Will" saat pertempuran dimulai.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_8003_Ultra.png" alt="Spirit-Warming Flame" />
                      <h3 class="character-info-skill-title">Eidolon 5</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Spirit-Warming Flame</h4>
                      <p class="character-info-skill-description">Level Ultimate +2, maksimal Lv. 15. Level Basic Attack +1, maksimal Lv. 10.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_8003_Rank6.png" alt="City-Forging Bulwarks"  />
                      <h3 class="character-info-skill-title">Eidolon 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">City-Forging Bulwarks</h4>
                      <p class="character-info-skill-description">Meningkatkan 10% DEF Trailblazer setelah melancarkan Enhanced Basic Attack atau Ultimate, dapat ditumpuk hingga 3 lapis.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="character-info-skills" id="traces">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_8003_Rank1.png" alt="The Strong Defends the Weak" />
                      <h3 class="character-info-skill-title">Ascension 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">The Strong Defends the Weak</h4>
                      <p class="character-info-skill-description">
                    Setelah menggunakan Skill, Damage yang diterima seluruh rekan berkurang 15% selama 1 Turn
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_8003_Rank2.png" alt="Unwavering Gallantry" />
                      <h3 class="character-info-skill-title">Ascension 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Unwavering Gallantry</h4>
                      <p class="character-info-skill-description">Menggunakan Enhanced Basic ATT mengembalikan HP Trailblaze sebesar 5% dari Max HP nya</p>
                    </div>
                  </div>

                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_8003_Ultra.png" alt="Action Beats Overthinking"/>
                      <h3 class="character-info-skill-title">Ascension 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Action Beats Overthinking</h4>
                      <p class="character-info-skill-description">Jika Trailblazer dilindungi Shield pada saat gilirannya dimulai, meningkatkan 15% ATK dan memulihkan 5 Energy sampai aksinya berakhir.</p>
                    </div>
                  </div>
                </div>
            ...
            <h3 class="character-info-skill-title">Basic Attack</h3>
               ...
               <div class="character-info-kelebihan" style="background-color: #1a237e;">
                  <div class="row">
                  <iframe width="700" height="600" src="https://www.youtube.com/embed/CLN9c6CEkPE?si=psXNrqvu-M3e5jod" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                  </div>
               </div>
               </div>
