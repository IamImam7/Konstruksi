<?php
  ...
  // Query karakter
  $query_karakter = "SELECT * FROM karakter_hsr WHERE nama = 'Serval'";
  ...
  ('Before Dawn', 'Today is Another Peaceful Day' , 'Night on the Milky Way' ,'Geniuses Repose', 'The Seriousness of Breakfast','Make the World Clamor')";
  ...
  ('Band Of Sizzling Thunder ','Musketeer of Wild Wheat')";
  ...
  ('Pan-Galactic Commercial Enterprise','Space Sealing Station')";
    ...
    <main class="content" >
        ...
        <div class="character-info-skills" id="skills">
          <h2 class="character-info-category">Skills</h2>
            ...
            <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1103_Normal.png" alt="Roaring Thunderclap"  />
            <h3 class="character-info-skill-title">Basic Attack</h3>
            </div>
          <div class="character-info-skill-body">
            <h4 class="character-info-skill-name">Roaring Thunderclap</h4>
            <h5 class="character-info-skill-type">Single Target</h5>
            <p class="character-info-skill-description">Memberikan Lightning DMG sebesar 50% dari ATK Serval kepada satu musuh.</p>
          </div>
        </div>

        <div class="character-info-skill">
          <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1103_BP.png" alt="Lightning Flash" />
                <h3 class="character-info-skill-title">Skill</h3>
          </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Lightning Flash</h4>
                  <h5 class="character-info-skill-type">AoE ATK</h5>
                    <p class="character-info-skill-description">
                    Mengakibatkan Lightning DMG sebesar 0.7% ATK Serval pada 1 target musuh, dan di saat bersamaan mengakibatkan Lightning DMG sebesar 0.3% ATK Serval pada musuh di sekitar target. Selain itu, target musuh yang terkena serangan memiliki 0.8% peluang dasar untuk memasuki status Shock selama 2 giliran. Selama dalam status Shock, target musuh akan menerima Lightning DoT sebesar 0.4% ATK Serval setiap gilirannya dimulai.
                    </p>
                  </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1103_Passive.png" alt="Galvanic Chords"/>
                <h3 class="character-info-skill-title">Talent</h3>
                </div>
                <div class="character-info-skill-body">
                  <h4 class="character-info-skill-name">Galvanic Chords</h4>
                  <h5 class="character-info-skill-type">Enhance</h5>
                <p class="character-info-skill-description">
                Setelah menyerang, mengakibatkan Lightning DMG tambahan sebesar 0.36% ATK Serval pada seluruh target musuh dengan status Shock.
                </p>
            </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
              <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1103_Maze.png" alt="Good Night, Belobog" />
                  <h3 class="character-info-skill-title">Technique</h3>
                </div>
              <div class="character-info-skill-body">
                <h4 class="character-info-skill-name">Good Night, Belobog</h4>
                <h5 class="character-info-skill-type">Enhance</h5>
                <p class="character-info-skill-description">
                Secara Langsung Menyerang musuh. Setelah memasuki pertarungan, memberikan Lightning DMG yang setara dengan 50% dari serval ATK kepada musuh secara acak. Dengan 100% kemunginan dasar untuk seluruh musuh mendapatkan debuff berupa Shock selama 3 Turn. Ketika dalam status Shocked, musuh akan menerima Lightning DoT yang setara dengan 50% ATK serval saat awal pertarungan
</p>
              </div>
          </div>
          ...
          <div class="character-info-skill">
            <div class="character-info-skill-header">
                <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1103_Ultra_on.png" alt="Here Comes the Mechanical Fever"/>
                    <h3 class="character-info-skill-title">Ultimate</h3>
                    </div>
                  <div class="character-info-skill-body">
                    <h4 class="character-info-skill-name">Here Comes the Mechanical Fever</h4>
                    <h5 class="character-info-skill-type">AoE ATK</h5>
                      <p class="character-info-skill-description">Mengakibatkan Lightning DMG sebesar 1.08% ATK Serval pada seluruh musuh, dan menambah durasi status Shock musuh selama 2 giliran.</p>
              </div>
          </div>
          </div>
          ...
          <div class="character-info-skills" id="eidolons">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1103_Rank1.png" alt="Echo Chamber"/>
                      <h3 class="character-info-skill-title">Eidolon 1</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Echo Chamber</h4>
                      <p class="character-info-skill-description">Basic Attack mengakibatkan Lightning DMG sebesar 60% DMG Basic ATK pada 1 musuh di sekitar target secara acak.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1103_Rank2.png" alt="Encore!"  />
                      <h3 class="character-info-skill-title">Eidolon 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Encore!</h4>
                      <p class="character-info-skill-description">Setiap kali DMG tambahan dari Talent Serval terpicu, akan memulihkan 4 Energy Serval.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1103_BP.png" alt="Listen, the Heartbeat of the Gears"/>
                      <h3 class="character-info-skill-title">Eidolon 3</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Listen, the Heartbeat of the Gears</h4>
                      <p class="character-info-skill-description">Level Skill +2, maksimal Lv. 15. Level Basic Attack +1, maksimal Lv. 10.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1103_Rank4.png" alt="Make Some Noise!" />
                      <h3 class="character-info-skill-title">Eidolon 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Make Some Noise!</h4>
                      <p class="character-info-skill-description">Saat melancarkan Ultimate, ada 100% peluang dasar untuk membuat target musuh yang tidak berstatus Shock memasuki status Shock yang serupa dengan Skill.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1103_Ultra.png" alt="Belobog's Loudest Roar!" />
                      <h3 class="character-info-skill-title">Eidolon 5</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Belobog's Loudest Roar!</h4>
                      <p class="character-info-skill-description">Level Ultimate +2, maksimal Lv. 15. Level Talent +2, maksimal Lv. 15.</p>
                    </div>
                  </div>
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1103_Rank6.png" alt="This Song Rocks to Heaven!"  />
                      <h3 class="character-info-skill-title">Eidolon 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">This Song Rocks to Heaven!</h4>
                      <p class="character-info-skill-description">Meningkatkan 30% DMG yang diakibatkan Serval pada target musuh yang berstatus Shock.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="character-info-skills" id="traces">
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1103_Rank1.png" alt="Rock 'n' Roll" />
                      <h3 class="character-info-skill-title">Ascension 2</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Rock 'n' Roll</h4>
                      <p class="character-info-skill-description">
                      Saat melancarkan Skill, meningkatkan 20% peluang dasar untuk membuat target musuh yang terserang memasuki status Shock.
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1103_Rank2.png" alt="String Vibration"  />
                      <h3 class="character-info-skill-title">Ascension 4</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">String Vibration</h4>
                      <p class="character-info-skill-description">Segera memulihkan 15 Energy saat pertempuran dimulai.</p>
                    </div>
                  </div>

                  <div class="character-info-skill">
                    <div class="character-info-skill-header">
                      <img class="character-info-skill-icon" src="../../img/Skill/SkillIcon_1103_Ultra.png" alt="Mania" />
                      <h3 class="character-info-skill-title">Ascension 6</h3>
                    </div>
                    <div class="character-info-skill-body">
                      <h4 class="character-info-skill-name">Mania</h4>
                      <p class="character-info-skill-description">Meningkatkan 20% ATK selama 2 giliran setelah mengalahkan target musuh.</p>
                    </div>
                  </div>
                </div>
            ...
            <h3 class="character-info-skill-title">Basic Attack</h3>
               ...
               <div class="character-info-kelebihan" style="background-color: #1a237e;">
                  <div class="row">
                  <iframe width="700" height="600" src="https://www.youtube.com/embed/StPQmo-163s?si=1vdu2iRybngsGEVk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                  </div>
               </div>
               </div>
