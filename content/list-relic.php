          ...
          <div class="row">
            <main class="content">
              <div class="content-header">
                <h1 class="content-title" style="color:#ffffff;">Honkai: Star Rail Relics List</h1>
              ...
              <div class="light-cones">
                <div class="light-cones-item">
                  <img  src="../form/dashboard/admin/Relics/<?php echo $row['gambar'];?>" style="padding: 10px;width: 150px; height:150px;" />
                  <div class="light-cones-body">
                    ...
                    <div class="light-cones-set">
                      ...
                      <p class="light-cones-description"><?php echo $row['set2']; ?></p>
                    </div>
                    <div class="light-cones-set">
                      <div class="light-cones-count">4</div>
                      <p class="light-cones-description"><?php echo $row['set4']; ?></p>
                    </div>
                  </div>
                </div>
                <?php
