...
<div class="wrapper">
    ...
    <div class="main_content">
        <div class="header">Update Lightcone</div>  
        <center><a href="tambah_lightcone/tambah_lightcone.php">+ &nbsp; Tambah Lightcone </a></center>
        <div class="info">
        <table>
                <thead>
                    <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit_lightcone/edit_lightcone.php?id=<?php echo $row['id']; ?>">Edit</a>
                        <a href="delete_lightcone/delete_lightcone.php?id=<?php echo $row['id'];?>">Delete</a>
                    </td>
                </tr>
                <?php
                    $no++;
