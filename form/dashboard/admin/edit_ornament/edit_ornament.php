<?php
    ...
    if (isset($_GET['id'])){
        ...
        $query = "SELECT * FROM ornament WHERE id='$id'";
...
<html>
  ...
  <body>
      <center>
        <h1>Edit Ornament <?php echo $data['nama']; ?></h1>
      <center>
      ...
      <section class="base">
        ...
        <div>
          ...
          <img src="../Ornaments/<?php echo $data['gambar']; ?>" style="width: 120px;float: left;margin-bottom: 5px;">
